...
import { WorkspaceNotes } from "@/components/pages/workspace-notes"

export const metadata = {
  title: "Workspace - NotesApp",
  description: "Manage notes in your workspace",
}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              <div className="hidden gap-6 md:flex">
                ...
                <Link href="/workspaces" className="text-sm font-medium text-foreground hover:text-primary-600">
                  Workspaces
                </Link>
              </div>
            </div>
